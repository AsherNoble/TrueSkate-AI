...
Usage:
    python -u scripts/model2/train_sequence_model.py --smoke
    python -u scripts/model2/train_sequence_model.py --data data/sls_xctest/<sess> --epochs 20
"""
...
from trueskate_ai.model2.tokens import STROKE_DIM  # noqa: E402
from trueskate_ai.model2.policy import (  # noqa: E402
...
def main() -> None:
    ...
    from trueskate_ai.model2.dataset import SequenceDataset  # noqa: PLC0415
