...
Usage:
    python scripts/collection/collect_sls_xctest.py --devices iPhone_XR --segment-min 5
"""
...
def _execute(worker: DeviceSession, g, *, calibration_tap_hold_s: float = 0.0) -> None:
...
def _recover_session(worker: DeviceSession) -> bool:
...
def _exit_replay(worker: DeviceSession) -> None:
