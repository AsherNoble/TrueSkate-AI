...
Usage:
    python scripts/collection/collect_self_labeled_traces.py --device iPhone_XR \
...
from trueskate_ai.sim.device import DEVICES, DeviceSession  # noqa: E402
...
from trueskate_ai.collection.color_recorder import TimestampedColorRecorder  # noqa: E402
