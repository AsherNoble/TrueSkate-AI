...
image = (
    ...
    .add_local_file(str(_ROOT / "scripts" / "model1" / "train_basic_linear_regressor.py"),
                    remote_path="/root/scripts/model1/train_basic_linear_regressor.py")
)
...
def _trainer():
    spec = importlib.util.spec_from_file_location(
        "train_basic_linear_regressor", "/root/scripts/model1/train_basic_linear_regressor.py",
    )
...
def evaluate_refinement(data_subdir: str, checkpoint_name: str, *, seed: int = 0,
    ...
    from torch.utils.data import DataLoader, Subset
    from trueskate_ai.model1.linear.dataset import BasicLinearClipDataset, split_by_command
    from trueskate_ai.model1.linear.refinement import refine_linear_endpoints
    from trueskate_ai.model1.linear.training import basic_linear_metrics
...
def audit_endpoint_residuals(data_subdir: str, checkpoint_name: str, *, seed: int = 0,
    ...
    from torch.utils.data import DataLoader, Subset
    from trueskate_ai.model1.linear.dataset import BasicLinearClipDataset, split_by_command
    from trueskate_ai.model1.linear.training import knot_component_labels
