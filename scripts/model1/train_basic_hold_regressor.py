...
Example:
  PYTHONPATH=src .venv/bin/python scripts/model1/train_basic_hold_regressor.py \\
...
from trueskate_ai.model1.hold.regressor import BasicHoldRegressor  # noqa: E402
from trueskate_ai.model1.hold.training import (  # noqa: E402
