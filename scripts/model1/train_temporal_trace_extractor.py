...
Examples:
    python scripts/model1/train_temporal_trace_extractor.py --smoke
    python scripts/model1/train_temporal_trace_extractor.py \
...
from trueskate_ai.model1.temporal.dataset import (  # noqa: E402
...
from trueskate_ai.model1.temporal.predictor import (  # noqa: E402
    TemporalTracePredictor,
)
from trueskate_ai.model1.temporal.training import (  # noqa: E402
