...
Usage:
    ...
    python scripts/model1/train_trace_extractor.py --data data/self_labeled_traces/iPhone_XR_<ts> --epochs 20
"""
...
class SelfLabeledTraceDataset(Dataset):
    ...
    def _add(self, frame_path: Path, nx: float, ny: float, sx: float, sy: float) -> bool:
        ...
        if self.cache_frames:
            ...
            from trueskate_ai.model2.frame_prep import prep_frame_rgb  # lazy import
...
def train(dataset: Dataset, *, epochs: int, batch_size: int, lr: float,
    ...
    if smoke:
        ...
        from trueskate_ai.model1.heatmap.model import GaussianBumpPredictor, GaussianBumpLoss  # lazy import
