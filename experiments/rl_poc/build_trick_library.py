...
Reads a JSONL log produced by run_cmaes.py, filters rows matching a given
trick name, and computes median and best gesture recipes.

Usage:
    python experiments/rl_poc/build_trick_library.py --log <jsonl_path> --trick <name>

Output:
    experiments/rl_poc/trick_libraries/<trick_name>_<timestamp>.json
"""
import argparse
import json
import re
...
from action_param import clamp_params, unpack_action
