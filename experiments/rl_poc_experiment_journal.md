...
- Scope is deliberately narrow: duration `0.30–1.20s`, horizontal reach `|dx|>=0.16`, and `|slope|<=2.5`; vertical/near-vertical paths, curves, holds, taps, multi-touch, and spin are outside this MVP. Taps remain 20% calibrated segment timing controls but are rejected by the strict dataset.
